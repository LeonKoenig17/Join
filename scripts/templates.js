        ...
        <div class="task-overlay" id="taskOverlay" onclick="handleOverlayClick(event)">
            <div class="task-card">
                <div class="task-header">
                    <span class="task-category ${task.category ? task.category.toLowerCase().replace(' ', '-') : ''}">${task.category || ''}</span>
                ...
                <div class="task-content">
                    ...
                    <div class="task-details">
                        ...
                        <div class="priority">
                            <span>Priority:</span>
                            <span class="priority-level ${task.priority ? task.priority.toLowerCase() : ''}">${task.priority || ''}</span>
                        </div>
...
function generateSubtasksHTML(subtasks) {
  return subtasks.map(subtask => /*html*/`
